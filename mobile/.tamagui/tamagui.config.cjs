...
var require_View = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/View/index.js"(exports2, module2) {
    ...
    var View2 = /* @__PURE__ */ React.forwardRef((props, forwardedRef) => {
...
var require_VirtualizedListContext = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/VirtualizedList/VirtualizedListContext.js"(exports2) {
    ...
    var React = _react;
    var __DEV__ = process.env.NODE_ENV !== "production";
    var VirtualizedListContext = exports2.VirtualizedListContext = /* @__PURE__ */ React.createContext(null);
    if (__DEV__) {
...
var require_VirtualizedListCellRenderer = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/VirtualizedList/VirtualizedListCellRenderer.js"(exports2, module2) {
    ...
    var _invariant = _interopRequireDefault(require_invariant());
    var React = _interopRequireWildcard(require("react"));
    var CellRenderer = class extends React.Component {
      static {
...
var require_FlatList = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/FlatList/index.js"(exports2, module2) {
    ...
    var FlatList = class extends React.PureComponent {
      static {
...
var require_VirtualizedSectionList = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/VirtualizedSectionList/index.js"(exports2, module2) {
    ...
    var VirtualizedSectionList = class extends React.PureComponent {
      static {
...
var require_SectionList = __commonJS({
  "node_modules/react-native-web/dist/cjs/vendor/react-native/SectionList/index.js"(exports2, module2) {
    ...
    var SectionList = class extends React.PureComponent {
      static {
...
var require_Text = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/Text/index.js"(exports2, module2) {
    ...
    var pickProps = /* @__PURE__ */ __name((props) => (0, _pick.default)(props, forwardPropsList), "pickProps");
    var Text3 = /* @__PURE__ */ React.forwardRef((props, forwardedRef) => {
    ...
    var _default = exports2.default = Text3;
    module2.exports = exports2.default;
  }
});
...
var require_ActivityIndicator = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/ActivityIndicator/index.js"(exports2, module2) {
    ...
    var ActivityIndicator2 = /* @__PURE__ */ React.forwardRef((props, forwardedRef) => {
...
var require_KeyboardAvoidingView = __commonJS({
  "node_modules/react-native-web/dist/cjs/exports/KeyboardAvoidingView/index.js"(exports2, module2) {
    ...
    var KeyboardAvoidingView = class extends React.Component {
      static {
...
__export(esm_exports, {
  Anchor: () => Anchor,
  ClientOnly: () => import_core8.ClientOnly,
  ComponentContext: () => import_core8.ComponentContext,
  Configuration: () => import_core8.Configuration,
  EnsureFlexed: () => EnsureFlexed,
  Fieldset: () => Fieldset,
  FontLanguage: () => import_core8.FontLanguage,
  GroupContext: () => import_core8.GroupContext,
  Spinner: () => Spinner,
  TamaguiProvider: () => TamaguiProvider,
  Text: () => Text2,
  Theme: () => import_core8.Theme,
  View: () => import_core8.View,
  createComponent: () => import_core8.createComponent,
  createFont: () => import_core8.createFont,
  createShorthands: () => import_core8.createShorthands,
  createStyledContext: () => import_core8.createStyledContext,
  createTamagui: () => createTamagui,
  createTokens: () => import_core8.createTokens,
  createVariable: () => import_core8.createVariable,
  getCSSStylesAtomic: () => import_core8.getCSSStylesAtomic,
  getConfig: () => import_core8.getConfig,
  getMedia: () => import_core8.getMedia,
  getThemes: () => import_core8.getThemes,
  getToken: () => import_core8.getToken,
  getTokenValue: () => import_core8.getTokenValue,
  getTokens: () => import_core8.getTokens,
  getVariable: () => import_core8.getVariable,
  getVariableName: () => import_core8.getVariableName,
  getVariableValue: () => import_core8.getVariableValue,
  insertFont: () => import_core8.insertFont,
  isBrowser: () => import_core8.isBrowser,
  isChrome: () => import_core8.isChrome,
  isClient: () => import_core8.isClient,
  isServer: () => import_core8.isServer,
  isTamaguiComponent: () => import_core8.isTamaguiComponent,
  isTamaguiElement: () => import_core8.isTamaguiElement,
  isTouchable: () => import_core8.isTouchable,
  isVariable: () => import_core8.isVariable,
  isWeb: () => import_core8.isWeb,
  isWebTouchable: () => import_core8.isWebTouchable,
  matchMedia: () => import_core8.matchMedia,
  mediaObjectToString: () => import_core8.mediaObjectToString,
  mediaQueryConfig: () => import_core8.mediaQueryConfig,
  mediaState: () => import_core8.mediaState,
  setConfig: () => import_core8.setConfig,
  setOnLayoutStrategy: () => import_core8.setOnLayoutStrategy,
  setupDev: () => import_core8.setupDev,
  styled: () => import_core8.styled,
  themeable: () => import_core8.themeable,
  useConfiguration: () => import_core8.useConfiguration,
  useDidFinishSSR: () => import_core8.useDidFinishSSR,
  useEvent: () => import_core8.useEvent,
  useGet: () => import_core8.useGet,
  useIsTouchDevice: () => import_core8.useIsTouchDevice,
  useIsomorphicLayoutEffect: () => import_core8.useIsomorphicLayoutEffect,
  useMedia: () => import_core8.useMedia,
  useProps: () => import_core8.useProps,
  usePropsAndStyle: () => import_core8.usePropsAndStyle,
  useStyle: () => import_core8.useStyle,
  useTheme: () => import_core8.useTheme,
  useThemeName: () => import_core8.useThemeName,
  variableToString: () => import_core8.variableToString,
  withStaticProperties: () => import_core8.withStaticProperties
});
__reExport(esm_exports, require("@tamagui/spacer"));
__reExport(esm_exports, require("@tamagui/accordion"));
__reExport(esm_exports, require("@tamagui/adapt"));
__reExport(esm_exports, require("@tamagui/alert-dialog"));
__reExport(esm_exports, require("@tamagui/animate"));
__reExport(esm_exports, require("@tamagui/animate-presence"));
__reExport(esm_exports, require("@tamagui/avatar"));
__reExport(esm_exports, require("@tamagui/button"));
__reExport(esm_exports, require("@tamagui/card"));
__reExport(esm_exports, require("@tamagui/checkbox"));
__reExport(esm_exports, require("@tamagui/collapsible"));
__reExport(esm_exports, require("@tamagui/compose-refs"));
__reExport(esm_exports, require("@tamagui/create-context"));
__reExport(esm_exports, require("@tamagui/dialog"));
__reExport(esm_exports, require("@tamagui/font-size"));
__reExport(esm_exports, require("@tamagui/form"));
__reExport(esm_exports, require("@tamagui/group"));
__reExport(esm_exports, require("@tamagui/react-native-media-driver"));
__reExport(esm_exports, require("@tamagui/elements"));
__reExport(esm_exports, require("@tamagui/helpers-tamagui"));
__reExport(esm_exports, require("@tamagui/image"));
__reExport(esm_exports, require("@tamagui/label"));
__reExport(esm_exports, require("@tamagui/list-item"));
__reExport(esm_exports, require("@tamagui/menu"));
__reExport(esm_exports, require("@tamagui/context-menu"));
__reExport(esm_exports, require("@tamagui/create-menu"));
__reExport(esm_exports, require("@tamagui/popover"));
__reExport(esm_exports, require("@tamagui/popper"));
__reExport(esm_exports, require("@tamagui/portal"));
__reExport(esm_exports, require("@tamagui/progress"));
__reExport(esm_exports, require("@tamagui/radio-group"));
__reExport(esm_exports, require("@tamagui/scroll-view"));
__reExport(esm_exports, require("@tamagui/select"));
__reExport(esm_exports, require("@tamagui/separator"));
__reExport(esm_exports, require("@tamagui/shapes"));
__reExport(esm_exports, require("@tamagui/sheet"));
__reExport(esm_exports, require("@tamagui/slider"));
__reExport(esm_exports, require("@tamagui/stacks"));
__reExport(esm_exports, require("@tamagui/switch"));
__reExport(esm_exports, require("@tamagui/tabs"));
__reExport(esm_exports, require("@tamagui/text"));
__reExport(esm_exports, require("@tamagui/theme"));
__reExport(esm_exports, require("@tamagui/toast"));
__reExport(esm_exports, require("@tamagui/toggle-group"));
__reExport(esm_exports, require("@tamagui/tooltip"));
__reExport(esm_exports, require("@tamagui/use-controllable-state"));
__reExport(esm_exports, require("@tamagui/use-debounce"));
__reExport(esm_exports, require("@tamagui/use-force-update"));
__reExport(esm_exports, require("@tamagui/element"));
__reExport(esm_exports, require("@tamagui/use-window-dimensions"));
__reExport(esm_exports, require("@tamagui/visually-hidden"));
...
var TamaguiProvider = /* @__PURE__ */ __name(({
  children,
  ...props
}) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_core2.TamaguiProvider, {
  ...props,
...
var Anchor = AnchorFrame.styleable(({
  ...
  rel,
  ...props
}, ref) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(AnchorFrame, {
  ...props,
  ...import_constants.isWeb ? {
    ...
    onPress: /* @__PURE__ */ __name((event) => {
      props.onPress?.(event), href !== void 0 && import_react_native_web.Linking.openURL(href);
    }, "onPress")
  },
  ref
}));
...
var Fieldset = (0, import_core5.styled)(import_stacks.YStack, {
  name: "Fieldset",
  render: "fieldset",
...
// node_modules/tamagui/dist/esm/index.mjs
__reExport(esm_exports, require("@tamagui/input"));

// node_modules/tamagui/dist/esm/views/Spinner.mjs
var import_core6 = require("@tamagui/core");
var import_stacks2 = require("@tamagui/stacks");
var import_react_native_web2 = __toESM(require_cjs(), 1);
var import_jsx_runtime3 = require("react/jsx-runtime");
var Spinner = import_stacks2.YStack.styleable((props, ref) => {
  const {
    size,
    color: colorProp,
    ...stackProps
  } = props, theme = (0, import_core6.useTheme)();
  let color = colorProp;
  return color && color[0] === "$" && (color = (0, import_core6.variableToString)(theme[color])), /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_stacks2.YStack, {
    ref,
    ...stackProps,
    children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_react_native_web2.ActivityIndicator, {
      size,
      color
    })
  });
...
var Text2 = (0, import_core7.styled)(import_core7.Text, {
  variants: {
    unstyled: {
      false: {
        color: "$color"
...
// tamagui.config.ts
var tamaguiConfig = createTamagui(import_v3.config);
