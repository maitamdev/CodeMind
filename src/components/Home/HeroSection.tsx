...
export default function HeroSection() {
    ...
    return (
        <section ref={heroRef} className="relative w-full overflow-hidden bg-background">
            ...
            {/* 2. Moving Gradient Blobs (Glassmorphism feel) */}
            <motion.div
                animate={{
                    scale: [1, 1.2, 1],
            ...
            {/* 3. Radial spotlight following cursor */}
            <div
            ...
            <div className="relative z-10">
                ...
                <div className="px-6 pb-8">
                    ...
                    <motion.div
                        ...
                        className="border border-border divide-x divide-border flex overflow-x-auto"
                    >
                        {[
                            {
                                icon: Users,
