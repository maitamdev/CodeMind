 ...
 *     tags:
 *       - Users
 *     summary: API endpoint for /api/users/[username]/activities
 *     description: Tự động sinh tài liệu cho GET /api/users/[username]/activities. Hãy cập nhật mô tả chi tiết sau.
 *     responses:
 *       200:
